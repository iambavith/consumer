...
import {View, Text, StyleSheet, Dimensions, TouchableOpacity, Image, PermissionsAndroid, TextInput, FlatList, CheckBox, ScrollView, Platform} from "react-native"
        ...
        return(
            <View style={styles.Root} >
...

                   {
                    ...
                    this._renderMapComponent()
                    :
                    <View style={{marginTop : 0.15*screenHeight}} >

                    <ScrollView>

                    <Text style={[styles.Text1, {fontFamily : "SemiBold"}]} >Select Vehicle</Text>
                    ...
                    <View style={{flexDirection : "row", alignItems : "center"}} >
                        ...
                        <Image source={require("../assets/images/Icons/bike-fill.png")}
                        style={{
                            height : 0.08*screenHeight,
                         ...
                         <Text style={[styles.Text1, {marginLeft : 0}]} >Rental GoBike</Text>
                        ...
                        <Image source={require("../assets/images/Icons/auto-fill.png")}
                        style={{
                            height : 0.06*screenHeight,
                         ...
                         <Text style={[styles.Text1, {marginLeft : 0, marginTop : 0.015*screenHeight}]} >GoRickshaw</Text>
                    ...
                    <View style={{flexDirection : "row", alignItems : "center"}} >
                        <View>
                            <Text style={[styles.Text1, {fontFamily : "Medium"}]} >Select package</Text>
                            <Text style={[styles.Text5, {marginLeft : 0.04*screenWidth}]} >Extra changes on exceeding packing.</Text>
                        </View>
                        ...
                        color : "#0F7ADD", 
                        position : "absolute", 
                        right : 0.05*screenWidth}]} onPress={() => {this.setState({
                            rules : true
                        })}} >View Details</Text>
                    </View>
                    ...
                    <TouchableOpacity style={{
                         ...
                         <Text style={[styles.Text1, {marginLeft : 0}]} >1 hr</Text>
                         <Text style={[styles.Text5, {marginLeft : 0}]} >10km</Text>
                         <Text style={[styles.Text1, {marginLeft : 0, fontSize : 0.05*screenWidth, fontFamily : "SemiBold"}]} >₹ 100</Text>
                    ...
                    <TouchableOpacity style={{
                         ...
                         <Text style={[styles.Text1, {marginLeft : 0}]} >2 hr</Text>
                         <Text style={[styles.Text5, {marginLeft : 0}]} >20km</Text>
                         <Text style={[styles.Text1, {marginLeft : 0, fontSize : 0.05*screenWidth, fontFamily : "SemiBold"}]} >₹ 180</Text>
                    ...
                    <TouchableOpacity style={{
                         ...
                         <Text style={[styles.Text1, {marginLeft : 0}]} >4 hr</Text>
                         <Text style={[styles.Text5, {marginLeft : 0}]} >40km</Text>
                         <Text style={[styles.Text1, {marginLeft : 0, fontSize : 0.05*screenWidth, fontFamily : "SemiBold"}]} >₹ 250</Text>
                    ...
                    >
...

                        {
                            ...
                            <View style={{
                                ...
                                <Text style={styles.Text1} >For useage beyond 1hr 10km package, {"\n"}additional fare will be applicable as per your selected cartegory.</Text>
                            ...
                            <Text style={styles.Text1} >Rental can be used local travels only. Package cannot be change after booking is confirmed.</Text>
                            <Text style={styles.Text1} >For ride later bookings, advance booking fee Rs {"\n"}50 will be added to total bill.</Text>
...

                           {
                               ...
                               <View style={{
                                ...
                                <Text style={styles.Text5} > 7 Dec, 11.15pm</Text>
                                    </View>

                                    <IconButton icon="close" size={0.065*screenWidth} style={{
                                        position : "absolute",
                                        right : 0.05*screenWidth
                                    }} onPress={() => {
                                        this.setState({
...

                           {
                               ...
                               <Text style={{
                                ...
                                <Text style={{
                                   ...
                                   fontSize : 0.04*screenWidth,
                                   color : "#3E4958"
                               }} >We got your booking for 7 Dec 2020, 11.15 pm.{"\n"}Your ride details will be confirmed 15 min {"\n"}before the pickup time.</Text>
