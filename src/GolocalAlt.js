...
class GoLocalAlt extends React.Component{
        ...
        return(
            <View style={styles.Root} >
                     ...
                     />
                        ...
                        <View style={styles.Dash} />
                         ...
                         <TouchableOpacity style={styles.Button} onPress={() => {
                             ...
                             this.props.navigation.push("PickImage")
                         }} >
                         <Text style={{
                         fontFamily : "Bold",
                         fontSize : 0.045*screenWidth,
                ...
                <TouchableOpacity 
                        ...
                        <Image
                            source={require("../assets/images/box-1.png")}
                            style={{
                                height : 0.04*screenHeight,
...

                 {
                     ...
                     <View style={{
                        ...
                        <View style={{
                            ...
                            zIndex : 100,
                            bottom : 0,
                            borderTopLeftRadius : .045*screenWidth,
                            borderTopRightRadius : 0.045*screenWidth
                        }} > 
                        ...
                        <View style={{flexDirection : "row", alignItems : "center"}} >
                            ...
                            <Text style={[styles.Text1, {marginLeft : 0}]} >package Type</Text>
                            <Text style={styles.Text5} >Tap select the type of package</Text>
                            </View>
                        </View>
                        ...
                        <TouchableOpacity style={styles.Button} onPress={() => {
                            this.props.navigation.push("PackageDetails")
                            this.setState({
                                showPackageDetails : false,
                                addressSelected : false,
                                selectPayment : true
